...
#include "dis_tutorial3/msg/detail/task__rosidl_typesupport_fastrtps_cpp.hpp"
...
bool
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_dis_tutorial3
cdr_serialize(
  const dis_tutorial3::msg::Task & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  dis_tutorial3::msg::Task & ros_message)
{
  // Member: priority
  cdr >> ros_message.priority;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = dis_tutorial3::msg::Task;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const dis_tutorial3::msg::Task *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<dis_tutorial3::msg::Task *>(
    untyped_ros_message);
...
template<>
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_EXPORT_dis_tutorial3
const rosidl_message_type_support_t *
get_message_type_support_handle<dis_tutorial3::msg::Task>()
{
  return &dis_tutorial3::msg::typesupport_fastrtps_cpp::_Task__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, dis_tutorial3, msg, Task)() {
  return &dis_tutorial3::msg::typesupport_fastrtps_cpp::_Task__handle;
}
