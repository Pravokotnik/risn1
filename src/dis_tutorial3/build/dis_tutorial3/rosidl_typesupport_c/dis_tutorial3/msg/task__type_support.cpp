...
static const _Task_type_support_symbol_names_t _Task_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, dis_tutorial3, msg, Task)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, dis_tutorial3, msg, Task)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, dis_tutorial3, msg, Task)() {
  return &::dis_tutorial3::msg::rosidl_typesupport_c::Task_message_type_support_handle;
}
