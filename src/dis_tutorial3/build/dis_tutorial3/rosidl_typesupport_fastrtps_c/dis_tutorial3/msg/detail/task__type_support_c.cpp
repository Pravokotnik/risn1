...
#include "dis_tutorial3/msg/detail/task__rosidl_typesupport_fastrtps_c.h"
...
#include "dis_tutorial3/msg/rosidl_typesupport_fastrtps_c__visibility_control.h"
...
#include "rosidl_runtime_c/string.h"  // description, task_type
#include "rosidl_runtime_c/string_functions.h"  // description, task_type

// forward declare type support functions
ROSIDL_TYPESUPPORT_FASTRTPS_C_IMPORT_dis_tutorial3
...
using _Task__ros_msg_type = dis_tutorial3__msg__Task;
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_dis_tutorial3
size_t get_serialized_size_dis_tutorial3__msg__Task(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _Task__ros_msg_type * ros_message = static_cast<const _Task__ros_msg_type *>(untyped_ros_message);
...
static uint32_t _Task__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_dis_tutorial3__msg__Task(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_dis_tutorial3
size_t max_serialized_size_dis_tutorial3__msg__Task(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = dis_tutorial3__msg__Task;
    is_plain =
      (
...
static size_t _Task__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_dis_tutorial3__msg__Task(
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, dis_tutorial3, msg, Task)() {
