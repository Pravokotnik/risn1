...
bool dis_tutorial3__msg__task__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("dis_tutorial3.msg._task.Task", full_classname_dest, 28) == 0);
  }
  dis_tutorial3__msg__Task * ros_message = _ros_message;
  {  // priority
...
PyObject * dis_tutorial3__msg__task__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("dis_tutorial3.msg._task");
